...
const OffersPage = () => {
  return (
    <div className='flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12 bg-[var(--bg-main)]'>
      <div className='relative w-full max-w-2xl overflow-hidden rounded-3xl border border-white/10 bg-[var(--bg-card)] p-12 text-center backdrop-blur-xl shadow-2xl'>
        <div className='absolute top-0 right-0 -mt-10 -mr-10 h-64 w-64 rounded-full bg-[var(--color-primary)]/20 blur-[80px]' />
        ...
        <div className='relative z-10 flex flex-col items-center'>
          <div className='mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-white/5 border border-white/10 shadow-xl'>
            <TicketPercent className='h-10 w-10 text-[var(--color-primary)]' />
          </div>
          ...
          <div className='flex flex-wrap justify-center gap-4'>
            <div className='flex items-center gap-2 rounded-lg bg-white/5 px-4 py-2 text-sm text-zinc-300 border border-white/5'>
